...
def generate_business_kpis(dataframe):
    ...
    if value_column:
        ...
        if values is not None:
            ...
            if total_value >= 10000000:
              display_value = f"{total_value / 10000000:.2f} Cr"
            elif total_value >= 1000000:
              display_value = f"{total_value / 1000000:.2f} M"
            elif total_value >= 1000:
              display_value = f"{total_value / 1000:.2f} K"
            else:
              display_value = f"{total_value:.2f}"
    ...
    if value_column:
        ...
        if values is not None:
            ...
            total_value = round(values.mean(),2)
